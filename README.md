...
<div align=center><img src="http://chart.googleapis.com/chart?cht=tx&chl= $$ L_{reconstruciton} = -\frac{1}{n} \sum_{i}^{n}(x_i log(f(z_i)) + (1-x_i) log(1-f(z_i))) $$" style="border:none;"></div>     
